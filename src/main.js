...
<nav id="navbar" class="fixed top-0 left-0 right-0 z-50 transition-all duration-500">
  <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
    ...
    <div class="hidden md:flex items-center gap-8">
      ...
      <a href="/weddings.html" class="text-white/80 hover:text-white text-sm tracking-widest uppercase transition-colors font-[family-name:var(--font-accent)] font-light">Weddings</a>
      <a href="/corporate.html" class="text-white/80 hover:text-white text-sm tracking-widest uppercase transition-colors font-[family-name:var(--font-accent)] font-light">Corporate</a>
      <a href="/after-dark.html" class="text-white/80 hover:text-white text-sm tracking-widest uppercase transition-colors font-[family-name:var(--font-accent)] font-light">After Dark</a>
...
<div id="mobile-menu" class="mobile-menu fixed inset-0 z-50 bg-[#110e0a]/98 flex flex-col items-center justify-center gap-8">
  ...
  <a href="/weddings.html" class="mobile-link text-white text-xl font-[family-name:var(--font-accent)] font-light tracking-[0.2em] uppercase">Weddings</a>
  <a href="/corporate.html" class="mobile-link text-white text-xl font-[family-name:var(--font-accent)] font-light tracking-[0.2em] uppercase">Corporate</a>
  <a href="/after-dark.html" class="mobile-link text-white text-xl font-[family-name:var(--font-accent)] font-light tracking-[0.2em] uppercase">After Dark</a>
...
<footer class="bg-[#110e0a] py-16">
  <div class="max-w-7xl mx-auto px-6">
    ...
    <div class="grid md:grid-cols-3 gap-12 mb-12">
      ...
      <div><h4 class="text-[#c9943e] text-xs tracking-[0.2em] uppercase mb-4 font-[family-name:var(--font-accent)] font-light">Quick Links</h4><div class="space-y-2"><a href="#estate" class="block text-[#f0e6d3]/50 hover:text-white text-sm transition-colors">The Estate</a><a href="/weddings.html" class="block text-[#f0e6d3]/50 hover:text-white text-sm transition-colors">Weddings</a><a href="/corporate.html" class="block text-[#f0e6d3]/50 hover:text-white text-sm transition-colors">Corporate Events</a><a href="/after-dark.html" class="block text-[#f0e6d3]/50 hover:text-white text-sm transition-colors">After Dark</a><a href="#gallery" class="block text-[#f0e6d3]/50 hover:text-white text-sm transition-colors">Gallery</a><a href="#contact" class="block text-[#f0e6d3]/50 hover:text-white text-sm transition-colors">Contact</a></div></div>
